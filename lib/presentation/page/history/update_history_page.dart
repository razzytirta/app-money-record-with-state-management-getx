...
import 'package:app_money_record/presentation/controller/history/update_history_controller.dart';
...
class UpdateHistoryPage extends StatefulWidget {
  UpdateHistoryPage({super.key, required this.date, required this.historyId});
  final String date;
...
class _UpdateHistoryPageState extends State<UpdateHistoryPage> {
  final historyC = Get.put(UpdateHistoryController());
  ...
  @override
  void initState() {
    historyC.init(userC.data.id, widget.date);
    super.initState();
  }
